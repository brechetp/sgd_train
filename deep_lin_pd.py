...
if __name__ == '__main__':
    ...
    num_classes = len(train_dataset.classes) if args_model.dataset != 'svhn' else 10
    ...
    model, input_size = models.pretrained.initialize_model(args.model, pretrained=False, freeze=True, num_classes=num_classes)
    model.to(device)
